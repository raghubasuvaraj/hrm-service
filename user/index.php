...
body {
   min-height:100vh;
    ...
    background-image: linear-gradient(160deg, #6ea81a 0%, #80D0C7 100%);
}
...
.login-block button{
        border:unset;
		background-color: #6ea81a;
    	background-image: linear-gradient(160deg, #6ea81a 0%, #4e6865 100%);
}
.text-white{
    color: #fff;
}
...
<body>
    ...
    <h1 class="text-white">HR Management System</h1>
    <br>
    <br>
<div class="login-block">
    <h1>Login</h1>
    <img class="center" width="150" height="150" src="https://www.elrafact.com/wp-content/uploads/2020/04/ELRAFACT-3.png"  alt="Elrafact Technology Solutions">
